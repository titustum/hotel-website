...
<div class="bg-white">
    ...
    <section class="relative h-[30vh] min-h-100 flex items-center justify-center text-center overflow-hidden">
        <div class="absolute inset-0 z-0">
            <img src="{{ asset('images/conference-image.jpg') }}" alt="Chumba Resort landscape"
